...
function tggr_options_page() {
    add_menu_page(
        'GA4 DATALAYER',    // Page title
        'GA4 DATALAYER',             // Menu title
        'manage_options',            // Capability
        'wc-gtm-settings',           // Menu slug
        'tggr_options_page_html',  // Callback function
        plugins_url('/images/wp-logo-ga4.png', __FILE__),       // Icon URL (using a WordPress dashicon)
        25                           // Position
    );
}
...
function tggr_options_page_html() {
    ...
    <div class="wrap">
        <?php $image_url = PLUGIN_PATH . 'includes/admin/images/ga4-logo-apon.png'; ?>
                 ...
                 <div class="postbox">
                     <div class="custom-container">
                         <h1 class="custom-heading">
                             <span class="bolder">Welcome in the world of GA4 DataLayer By Apon!</span>
                             <span class="smaller">Check out Server Side Tracking</span>
                         </h1>
                         <p class="custom-paragraph">Enhance your website's performance and data privacy with server side tracking through Google Tag Manager. Discover the ease and efficiency of managing your tags on Ga4 Datalayer' reliable and user-friendly platform. Start optimizing your tagging strategy today!</p>
                         <div>
                             <a href="https://wa.me/+8801303744193" class="custom-button btn-primary" target="_blank">Support On Whatsapp</a>
                         </div>
                     </div>
                 </div>
            </div>
...
function tggr_url_toggle_cb() {
    ...
    echo ( '<p class="description">Read <a href="https://datamearsure.cloud/">this article</a> to find out how to use the Enhanced Tracking Script</p>' );
